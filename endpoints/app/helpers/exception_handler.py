...
class ExceptionType(enum.Enum):
    ...
    DATA_RESPONSE_MALFORMED = 500, '992', 'Something went wrong, please contact admin!'
...
async def fastapi_error_handler(request, exc):
    return JSONResponse(
        status_code=500,
        content=jsonable_encoder(ResponseSchemaBase().custom_response('500', "Something went wrong, please contact admin!"))
    )
